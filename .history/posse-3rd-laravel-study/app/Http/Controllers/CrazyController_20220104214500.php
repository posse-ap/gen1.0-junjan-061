...
class CrazyController extends Controller
{
    ...
    public function store_theme(Request $request, $id)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy_title($question_id)
    {
        $question = Question::find($question_id)->delete();
        return redirect('/admin');
    }

    public function destroy_theme($theme_id)
    {
        $theme = Theme::find($theme_id)->delete();
        return redirect('/admin');
    }

    public function destroy_choice($choice_id)
    {
        $theme = Choice::find($choice_id)->delete();
        return redirect('/admin');
    }
