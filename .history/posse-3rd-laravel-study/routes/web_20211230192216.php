...
Route::post("admin/destroy/{question_id}", "CrazyController@destroy_title")->name('admin.destroy_title');
...
Route::post("admin/theme/destroy", "CrazyController@destroy_theme")->name('admin.destroy_theme');
...
Route::post("admin/delete", "CrazyController@destroy_choice")->name('admin.destroy_choice');
