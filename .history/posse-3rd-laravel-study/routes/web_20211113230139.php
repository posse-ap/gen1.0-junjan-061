...
Route::get("admin/{question_id}/edit/{the}", "CrazyController@edit")->name('admin.edit');

Route::get("admin/{question_id}/edit/{theme_id}", "CrazyController@update")->name('admin.update');
